  ...
  return (
    <div className="animate-pulse">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="px-4 py-3 border-b border last:border-b-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="h-3 w-14 bg-hover rounded" />
          </div>
        </div>
      ))}
    </div>
...
function EmptyState() {
  return (
    <div className="p-8 text-center">
      <p className="text-secondary font-mono">No recent bets</p>
...
function LoadingSpinner() {
  return (
    <div className="flex justify-center py-4">
      <div className="w-5 h-5 border-2 border border-t-secondary rounded-full animate-spin" />
    </div>
  )
}
          ...
          {isLoading ? (
            ...
            <>
              ...
              {!hasMore && displayEvents.length > 0 && (
                <div className="py-3 text-center text-xs text-muted font-mono">
                  End of feed
                </div>
              )}
            </>
