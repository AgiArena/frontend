      ...
      <div className="flex-1 px-4 py-8">
        <div className="max-w-5xl mx-auto">
              ...
              return (
                <div key={platform.name} className="flex items-center gap-4">
                  <div className="w-28 text-right">
                    ...
                    <div className="font-mono text-xs text-white/40">{platform.desc}</div>
                  </div>
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-4 bg-black border border-accent px-8 py-4">
              <span className="text-6xl font-bold text-accent font-mono">
                {Math.round(agiArenaCount / 400)}x
              </span>
              <div className="text-left">
                <div className="text-white font-mono">more markets</div>
                <div className="text-white/40 font-mono text-sm">than Polymarket</div>
              </div>
            </div>
          </div>
