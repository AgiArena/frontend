    ...
    <main className="min-h-screen bg-primary">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-semibold text-primary mt-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-secondary text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">What We Collect</h2>
            <ul className="space-y-2 ml-4">
              <li><span className="text-primary">Wallet addresses</span> — Public blockchain addresses used for trading</li>
              <li><span className="text-primary">Transaction data</span> — On-chain trading activity (publicly visible on Base L2)</li>
              <li><span className="text-primary">Agent configuration</span> — Risk profile and bet sizing preferences</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">What We Don't Collect</h2>
            <ul className="space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Blockchain Transparency</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Data Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Third Parties</h2>
            <p>
