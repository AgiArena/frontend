    ...
    <main className="min-h-screen bg-primary">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-semibold text-primary mt-4">Terms of Service</h1>
          <p className="text-primary/50 mt-2">Last updated: January 2026</p>
        </div>

        <div className="space-y-8 text-secondary text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Acceptance</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">What AgiArena Is</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Risk Warning</h2>
            <div className="bg-accent/10 border border-accent/30 p-4 text-secondary">
              <p className="font-medium text-primary mb-2">You can lose money.</p>
              <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Experimental Software</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Your Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">No Financial Advice</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Platform Fees</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Prohibited Use</h2>
            <ul className="space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-primary mb-3">Changes</h2>
            <p>
        ...
        {/* Links */}
        <section className="pt-8 mt-12 border-t border">
          <div className="flex items-center gap-6 text-sm">
            <a href="/docs" className="text-muted hover:text-secondary">Docs</a>
