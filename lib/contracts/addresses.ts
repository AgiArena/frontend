 ...
 *
 * Network: Index L3 (Orbit) - Chain ID: 111222333 - WIND as collateral
 */
 ...
 */
export const CONTRACT_ADDRESS = network.contracts.agiArenaCore

/**
 * ResolutionDAO contract address
 */
export const RESOLUTION_CONTRACT_ADDRESS = network.contracts.resolutionDAO

/**
 * Collateral token address (WIND on Index L3)
 */
export const COLLATERAL_TOKEN_ADDRESS = network.collateralToken.address

/**
 * Collateral token symbol
 */
export const COLLATERAL_SYMBOL = network.collateralToken.symbol

/**
 * Collateral token decimals
 */
export const COLLATERAL_DECIMALS = network.collateralToken.decimals
